  ...
  return (
    <>
      <main className="min-h-screen flex flex-col items-center justify-center bg-gray-200">
        {/* card */}
        <div class="max-w-sm p-6 bg-gray-800 border border-gray-700 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <svg
            class="w-7 h-7 text-gray-400 dark:text-gray-400 mb-3"
            aria-hidden="true"
